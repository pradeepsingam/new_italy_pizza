...
const HeroBanner2 = () => {
    ...
    const heroContent = [
        {
            img: '/assets/img/banner/bannerThumb2_1.png', subtitle: 'Large Pizza', title: 'Large Pizza', btnname: 'MENU'
        },
        { img: '/assets/img/banner/bannerThumb2_2.png', subtitle: 'Wing deal', title: '10 Wings', btnname: 'MENU' },
        { img: '/assets/img/banner/bannerThumb2_3.png', subtitle: 'Family Combo', title: '02 Pizza + Wings', btnname: 'MENU' },
    ];
